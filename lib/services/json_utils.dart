...
//     try {
//       // Download the latest data from Firebase
//       final storageRef = FirebaseStorage.instance.ref().child('$fileName.json');
//       final directory = await getApplicationDocumentsDirectory();
//       final localFile = File('${directory.path}/$fileName.json');
//       await storageRef.writeToFile(localFile);
//       print('File downloaded from cloud storage.');
      
//       // Merge with local data
//       var localData = await readFromLocalJson(fileName);
//       var cloudData = jsonDecode(await localFile.readAsString());

//       if (cloudData is Map<String, dynamic> && cloudData.containsKey('users')) {
...
//       }
//     } catch (e) {
//       print('Error downloading or merging file: $e');
//     }
//   } else {
...
//       var localChatRooms = localData[0]['chatRooms'] as List;
//       var cloudChatRooms = cloudData[0]['chatRooms'] as List;
...
//       var localMessages = localData[0]['messages'] as List;
//       var cloudMessages = cloudData[0]['messages'] as List;
...
//       return (data[0]['messages'] as List).map((json) => Message.fromMap(json, json['id'])).toList();
//     }
//     return [];
//   }
